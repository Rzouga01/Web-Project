					...
					<?php if (!empty($donations)) { ?>
						<table class="table table-bordered">
							...
							<?php foreach ($donations as $donation): ?>
								<tr>
									<td align="center">
										<?= htmlspecialchars($donation['Ref_Donation']) ?>
									</td>
									<td align="center">
										<?= htmlspecialchars($donation['ID_USER']) ?>
									</td>
									<td align="center">
										<?= htmlspecialchars($donation['ID_Project']) ?>
									</td>
									<td align="center">
										<?= htmlspecialchars($donation['amount']) ?>
									</td>
									<td class="actionBtn">
										<a href="updateDonation.php?ref=<?= $donation['Ref_Donation'] ?>"
											>Update</a>
										<a href="deleteDonation.php?ref=<?= $donation['Ref_Donation'] ?>"
											>Delete</a>
									</td>
								</tr>
							<?php endforeach; ?>
